...
class ConfigManager {
  ...
  _initializeDefaultConfig() {
    const defaultConfig = {
      ...
      COMMANDS_MANIFEST: [
        "adventure", "alias", "awk", "backup", "base64", "basic", "bc", "beep", "cat", "cd", "check_fail", "chgrp", "chidi", "chmod", "chown", "cksum", "clear", "clearfs", "code", "cp", "csplit", "curl", "date", "delay", "df", "diff", "du", "echo", "edit", "explore", "export", "find", "gemini", "grep", "groupadd", "groupdel", "groups", "head", "help", "history", "kill", "less", "listusers", "loadstate", "log", "login", "logout", "ls", "ln", "man", "more", "mkdir", "mv", "nl", "ocrypt", "paint", "passwd", "play", "printscreen", "ps", "pwd", "reboot", "remix", "removeuser", "reset", "restore", "rm", "rmdir", "run", "savefs", "savestate", "sed", "set", "shuf", "sort", "su", "sudo", "sync", "synth" ,"tail", "touch", "tree", "unalias", "uniq", "unset", "unzip", "upload", "useradd", "usermod", "visudo", "wc", "wget", "whoami", "xor", "zip", "xargs", "ln"
      ],
    };
