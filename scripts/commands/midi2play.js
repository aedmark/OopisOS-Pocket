...
const MIDI_PARSER_URL = 'https://cdn.jsdelivr.net/npm/midi-file-parser';
            ...
            input.onchange = async (e) => {
                ...
                reader.onload = async (event) => {
                    try {
                        ...
                        const midi = new window.MidiFile(arrayBuffer);
                        ...
                        for (const note of allNotes) {
                            if (note.duration > 0) {
                                ...
                                if (delayTicks > 0) {
                                    const delayMs = Math.round((delayTicks / ticksPerBeat) * (60000 / midi.header.bpm));
